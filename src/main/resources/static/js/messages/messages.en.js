var resources = {
    ...
    'minWithdrawalNotice':'Minimum allowed withdrawal amount is {0} USDT.',
    'maxWithdrawalNotice':'Maximum allowed withdrawal amount is {0} USDT.',
    'totalWithdrawalProfit':'Your total profit withdrawn up to date is {0} USDT.',
    'transferFee':'Transfer fee is {0} USDT.',
    'inviteXFriends':'Invite {0} Friends',
    'claim':'Claim',
    'subscriptionCanceled':'Your subscription will be canceled! are you sure?',
    'subscriptionDowngraded':`Your subscription will be downgraded to "{0}"! are you sure?`
};